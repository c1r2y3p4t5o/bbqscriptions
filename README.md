...
A minter and protocol for inscriptions on BBQCoin.
...
*Then send BBQcoin to the address displayed. Once sent, sync your wallet:*
...
**Examples:**
    ...
    node . mint bLUZiX5AjXB8LrzWLeLbMqCMQmHCMwfKq7 dog.jpeg

    node . mint bLUZiX5AjXB8LrzWLeLbMqCMQmHCMwfKq7 mint.json 100
...
The BBQScriptions protocol allows any size data to be inscribed onto subwoofers.
